...
<head>
    ...
    <style>
        ...
        .navbar h3 { margin: 0; font-size: 20px; font-weight: 700; display: flex; align-items: center; gap: 10px; }
        .nav-links { display: flex; align-items: center; gap: 20px; }
        .nav-item { color: white; text-decoration: none; font-weight: 500; opacity: 0.9; transition: opacity 0.2s; }
...
<div class="container">
    ...
    <div class="grid-container">
        ...
        <div class="card">
            <h2>🔍 Quick Search</h2>
            <p style="color:#6b7280; margin-bottom:15px;">Find students by name, code, or email.</p>
